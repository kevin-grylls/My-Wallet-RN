...
const makeExample = (name: string, getJson: Function, width?: number) => ({
  name,
  getJson,
  width
});
...
export class Sample extends React.Component<IProps, IState> {
  ...
  manageAnimation = (shouldPlay: any) => {
  ...
  onProgressChange = (progress: any) => this.state.progress.setValue(progress);
  onDurationChange = (duration: any) => this.setState({ duration });
